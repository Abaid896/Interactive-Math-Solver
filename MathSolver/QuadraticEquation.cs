            ...
            if (NotNullFields())
            {
                try
                {
                    ...
                    if (discriminant < 0)
                    {
                        ...
                        lblResult1.Text = string.Format("{0:0.##} + {1:0.##}i", realPart, imaginaryPart);
                        lblResult2.Text = string.Format("{0:0.##} - {1:0.##}i", realPart, imaginaryPart);
                    }
                    else if (discriminant == 0)
                    {
                        // Display the result for a single root
                        double root = -b / (2 * a);
                        lblResult1.Text = root.ToString();
                        lblResult2.Text = root.ToString();
                    }
                    else
                    {
                        ...
                        lblResult1.Text = root1.ToString();
                        lblResult2.Text = root2.ToString();
                    }
                }
